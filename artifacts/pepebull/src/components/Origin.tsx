    ...
    <section className="w-full section-cream py-24 px-4 overflow-hidden relative">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <ScrollReveal className="order-2 lg:order-1">
          <h2 className="font-fredoka text-5xl md:text-6xl lg:text-7xl text-[#1A1A1A] text-stroke-amber mb-6 leading-tight">
        ...
        <ScrollReveal delay={0.2} className="order-1 lg:order-2 flex justify-center">
          <div className="relative">
            <img 
              ...
              className="relative w-full max-w-md aspect-square object-cover rounded-2xl border-2 border-[#1A1A1A] hard-shadow-amber bg-white p-2"
            />
          </div>
        </ScrollReveal>
